                          ...
                          <li key={product.id} className="flex py-6">
                            ...
                            <div className="ml-4 flex flex-1 flex-col">
                              ...
                              <div className="flex flex-1 items-end justify-between text-sm">
                                <p className="text-gray-500">Qty {product.qyt}</p>

                                <div className="flex">
                                  <button type="button" className="font-medium text-indigo-600 hover:text-indigo-500" onClick={() => removecart(index)}>
                                    Remove
                                  </button>
                                </div>
                              </div>
